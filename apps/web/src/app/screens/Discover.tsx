...
const LEARNING_REELS = [
  { id: 1, title: "How to run Kleench Campaigns", views: "12.5k", gradient: "linear-gradient(135deg, var(--app-text-alt), #1e3a5f)", author: "Kleench Team" },
  { id: 2, title: "Maximize your Social Reach",   views: "8.2k",  gradient: "linear-gradient(135deg, #7C3AED, #5b21b6)", author: "Digital Pro"  },
  { id: 3, title: "Selling Solar Effectively",    views: "15.3k", gradient: "linear-gradient(135deg, var(--app-orange), #c96a00)", author: "Energy Ltd"   },
...
const COMMUNITY_ADVERTS = [
  { id: 101, title: "Solar Light Installation",  reach: "45k", budget: "K500", icon: "rocket",   accent: "var(--app-orange)" },
              ...
              <div className="bg-[var(--app-bg)] rounded-3xl p-6 shadow-md border border-[var(--border)]">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <h2 className="font-black text-[18px] leading-tight" style={{ fontFamily: "Agrandir, sans-serif", color: "var(--app-text-alt)" }}>
                ...
                <div className="border-t pt-5 grid grid-cols-3 gap-3" style={{ borderColor: "rgba(13,27,62,0.06)" }}>
                  {[
                    { icon: "target",   label: "Target",  value: "68%",  accent: "var(--app-orange)" },
                    { icon: "chart",    label: "Spent",   value: "K850", accent: "var(--app-text-alt)" },
                      ...
                      <motion.div key={ad.id}
                       ...
                       >
                        ...
                        <div className="flex-1">
                          <p className="font-bold text-[14px]" style={{ fontFamily: "Agrandir, sans-serif", color: "var(--app-text-alt)" }}>{ad.title}</p>
