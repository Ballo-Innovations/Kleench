    ...
    <div className="min-h-screen bg-transparent text-[#0D1B2A] font-sans pb-32">
      ...
      <div className="px-5 pt-4 space-y-8">
        ...
        <motion.div 
          ...
          className="bg-white rounded-3xl p-6 border-2 border-[#0D1B2A] shadow-[4px_4px_0px_#0D1B2A] space-y-6"
        >
          {/* Destination Input */}
        ...
        <div className="bg-white rounded-3xl p-4 border-2 border-[#0D1B2A] shadow-[4px_4px_0px_#0D1B2A] flex gap-4">
          <button 
            onClick={() => setActiveTab("send")}
            className={`flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl transition-all ${
              activeTab === "send" ? "bg-[#0D1B2A] text-white shadow-lg" : "bg-slate-50 text-[#0D1B2A]/40"
            }`}
          >
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl transition-all ${
              activeTab === "received" ? "bg-[#0D1B2A] text-white shadow-lg" : "bg-slate-50 text-[#0D1B2A]/40"
            }`}
          >
