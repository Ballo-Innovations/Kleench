              ...
              <div className="space-y-10">
                  ...
                  <div className="space-y-10">
                    ...
                    >
                      {[0, 1, 2, 3].map((i) => (
                        <motion.div 
                          key={i}
                          className={`w-14 h-14 bg-white border-[3px] rounded-2xl shadow-[6px_6px_0px_#0D1B2A] flex items-center justify-center transition-colors ${
                            pin.length > i ? "border-[#5D56D8]" : "border-[#0D1B2A]"
                          }`}
                        >
                          {pin.length > i && (
                            <motion.div 
                    ...
                    <div className="flex flex-col items-center gap-6">
                      <div className="flex items-center gap-3">
                         <div className="p-2 bg-slate-50 border-2 border-[#0D1B2A] rounded-xl">
                             <DuotoneShieldCheck size={14} primary="#0D1B2A" />
                         </div>
                         <span className="text-[9px] font-black uppercase tracking-widest text-[#0D1B2A]">SECURED BY KLEENCH VAULT</span>
                      </div>
                        ...
                        {[1, 2, 3, 4, 5, 6, 7, 8, 9, "", 0, "backspace"].map((k, idx) => {
                          ...
                          return (
                            <motion.button
                              ...
                              className="h-14 bg-white border-[3px] border-[#0D1B2A] rounded-2xl shadow-[4px_4px_0px_#0D1B2A] flex items-center justify-center text-lg font-black"
                            >
                              {k === "backspace" ? <BackspaceKey size={20} color="#0D1B2A" /> : k}
                            </motion.button>
                          );
                        })}
                      </div>
               ...
               <div className="pt-2">
                <motion.button 
                  ...
                  className={`w-full h-18 text-white rounded-[24px] border-[3px] border-[#0D1B2A] shadow-[8px_8px_0px_#0D1B2A] flex items-center justify-center font-black uppercase tracking-[0.5em] text-xs transition-all duration-300 ${
