          ...
          >
            ...
            <section>
              <div className="flex items-center justify-between mb-1 px-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[9px] font-black text-slate-700 uppercase tracking-[0.2em] leading-none">
                    Free Videos
                  </h3>
                </div>
                <span
                  onClick={() => navigate("/learning/viewer?mode=free")}
                  className="text-slate-400 font-bold text-[8px] uppercase tracking-widest whitespace-nowrap cursor-pointer"
                >
                  See All
                </span>
              </div>
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex justify-between items-end">
                      <div className="flex-1 pr-1">
                        ...
                        <div className="flex items-center gap-1 mt-0.5">
                          <UserIcon size={8} primary="#94a3b8" />
            ...
            <section>
              <div className="flex items-center justify-between mb-1 px-1">
                ...
                <span className="text-slate-400 font-bold text-[8px] uppercase tracking-widest whitespace-nowrap cursor-pointer">
                  See All
                </span>
              </div>
              <div className="-mx-5 flex gap-3 overflow-x-auto pb-2 pl-5 pr-5 no-scrollbar" style={{ scrollbarWidth: "none" }}>
              ...
              {FREE_VIDEOS.slice(0, 3).map((vid) => (
                ...
                >
                  ...
                  <div className="p-3 flex flex-col justify-center flex-1 min-w-0">
                    <h4 className="font-bold text-slate-800 text-[10px] uppercase tracking-widest leading-none mb-1 truncate">{vid.title}</h4>
                    <div className="flex items-center gap-1.5 text-slate-500">
                      <UserIcon size={10} primary="#94a3b8" />
                      <span className="text-[9px] font-bold tracking-wider uppercase truncate">{vid.author}</span>
                    </div>
                    <div className="flex items-center gap-3 mt-1.5">
                      <div className="flex items-center gap-1 text-slate-400">
                        <EyeIcon size={10} primary="#94a3b8" />
                        <span className="text-[9px] font-bold">{vid.views}</span>
                      </div>
                      <span className="text-[9px] font-bold text-slate-400">{vid.duration}</span>
                    </div>
                  </div>
                </div>
              ))}
