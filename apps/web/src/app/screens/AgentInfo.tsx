  ...
  return (
    <div className="w-full max-w-md mx-auto bg-transparent font-sans pb-24">
      ...
      <div className="px-5 pt-4 pb-8">
        <CtaButton onClick={() => navigate("/marketplace/agent/terms", { state: { ...state, entityType, bizType, experience, agentCode, license: licenseFiles[0] ? { name: licenseFiles[0].file.name, size: licenseFiles[0].file.size, preview: licenseFiles[0].preview } : null } })} disabled={!canContinue}>Continue</CtaButton>
      </div>
    </div>
  );
}
