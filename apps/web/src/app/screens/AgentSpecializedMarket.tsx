  ...
  return (
    <div className="w-full max-w-md mx-auto bg-transparent font-sans pb-24">
      ...
      <div className="px-5 pt-4 pb-8">
        <CtaButton onClick={() => navigate("/marketplace/agent/terms", { state: { ...state, frequency, dataSources: sources, dataPoints: points } })} disabled={!canContinue}>Continue</CtaButton>
      </div>
    </div>
  );
}
