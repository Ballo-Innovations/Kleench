  ...
  return (
    <div className="w-full max-w-md mx-auto bg-transparent font-sans pb-24">
      ...
      <div className="px-5 pt-4 pb-8">
        <CtaButton onClick={() => navigate("/marketplace/list/detail", { state: { ...state, logo: toMeta(logoFiles)[0] || null, cover: toMeta(coverFiles)[0] || null, docs: toMeta(docsFiles)[0] || null } })} disabled={!canContinue}>Continue</CtaButton>
      </div>
    </div>
  );
}
