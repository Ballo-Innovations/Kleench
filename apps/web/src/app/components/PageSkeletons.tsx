...
export const PageSkeletons = {
        ...
        <div className="px-5 space-y-8">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 overflow-hidden -mx-5 px-5">
              {[1, 2, 3].map(i => (
                <div key={i} className="flex-shrink-0 w-[160px] h-[260px] border border-[#003366]/10 rounded-3xl shadow-md shadow-[#003366]/8 overflow-hidden bg-white" />
              ))}
            </div>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="h-24 border border-[#003366]/10 rounded-3xl shadow-md shadow-[#003366]/8 bg-white" />
            <div className="h-24 border border-[#003366]/10 rounded-3xl shadow-md shadow-[#003366]/8 bg-white" />
          </div>
          ...
          <div className="space-y-6">
            ...
            {[1, 2].map(i => (
              <div key={i} className="bg-white border border-[#003366]/10 rounded-3xl p-5 shadow-lg shadow-[#003366]/8 space-y-4">
        ...
        <div className="space-y-6">
          <div className="flex justify-center gap-7 mt-4 mb-2">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="flex flex-col items-center gap-2">
                <div className="w-12 h-12 rounded-full border border-[#003366]/10 shadow-sm bg-white" />
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3].map(i => (
                  <div key={i} className="h-14 rounded-2xl border border-slate-200 shadow-sm bg-white" />
                ))}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[1, 2].map(i => (
                  <div key={i} className="h-16 rounded-2xl shadow-sm bg-white border border-slate-200" />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex space-x-2">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="h-8 w-16 rounded-full border border-[#003366]/10 bg-white" />
              ))}
            </div>
              ...
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="flex items-center justify-between p-4 bg-white border border-slate-100 rounded-2xl shadow-sm">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full border border-[#003366]/10 bg-slate-100" />
                    <div className="space-y-2">
                      <div className="h-4 w-28 rounded-md bg-slate-100" />
      ...
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans pt-6">
        <div className="px-5 space-y-6">
          <div className="flex gap-3 overflow-hidden">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="h-10 w-24 border border-[#003366]/10 shadow-sm rounded-full flex-shrink-0 bg-white" />
            ))}
          </div>

          <div className="grid grid-cols-2 gap-5 pt-4">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="border border-[#003366]/10 rounded-[24px] p-4 shadow-md shadow-[#003366]/8 bg-white space-y-4">
    ...
    <Skeleton loading={true} animate="shimmer" name="discover">
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans pt-6">
        <div className="px-5 space-y-8 relative z-10">
          {[1, 2].map(i => (
            <div key={i} className="bg-white border border-[#003366]/10 rounded-[32px] p-6 shadow-lg shadow-[#003366]/8 space-y-5">
              <div className="flex justify-between">
                <div className="h-4 w-32 rounded-md bg-slate-100 opacity-40" />
                <div className="h-10 w-10 border border-[#003366]/10 rounded-xl shadow-sm bg-white" />
              </div>
              <div className="h-6 w-full rounded-md bg-slate-100" />
              <div className="h-10 w-[80%] rounded-md bg-slate-100 opacity-40" />
              <div className="h-14 w-full border border-[#003366]/10 rounded-2xl bg-slate-50" />
            </div>
          ))}
        </div>
      </div>
    ...
    <Skeleton loading={true} animate="shimmer" name="academy">
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans pt-1 overflow-x-hidden">
        <div className="px-4 relative z-20 space-y-4">
          <div className="flex items-center gap-3">
            <div className="flex-1 h-12 rounded-2xl border border-[#003366]/10 shadow-md shadow-[#003366]/8 bg-white" />
            <div className="w-16 h-12 rounded-2xl border border-[#003366]/10 shadow-md shadow-[#003366]/8 bg-white shrink-0" />
          </div>
            ...
            <div className="flex items-center justify-center gap-8 px-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="flex flex-col items-center justify-center gap-2">
                  <div className="w-14 h-14 rounded-full border border-[#003366]/10 shadow-md shadow-[#003366]/8 bg-white" />
                ...
                <div>
                  <div className="flex items-center justify-between mb-3 px-1">
                    <div className="flex items-center gap-2">
                      <div className="w-1.5 h-4 rounded-full bg-[#FF8C00]/40 shrink-0" />
                  ...
                  <div className="-mx-5 flex gap-4 overflow-hidden pb-2 pl-5 pr-5">
                    {[1, 2, 3, 4].map(cardIndex => (
                      <div key={cardIndex} className="relative flex-shrink-0 w-[112px] h-[160px] bg-white border border-[#003366]/10 shadow-md shadow-[#003366]/8 rounded-xl overflow-hidden">
  ...
  Product: () => (
    <Skeleton loading={true} animate="shimmer" name="product">
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans overflow-x-hidden pb-32">
        <div className="w-full h-[530px] bg-slate-100 border-b border-[#003366]/10" />

        <div className="px-6 -mt-20 relative z-30 space-y-10">
          <div className="flex items-center justify-between p-6 bg-white rounded-3xl border border-[#003366]/10 shadow-lg shadow-[#003366]/8">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full border border-[#003366]/10 bg-slate-100" />
              <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="h-32 rounded-[2rem] border border-[#003366]/10 bg-white shadow-lg shadow-[#003366]/8" />
            <div className="h-32 rounded-[2rem] border border-[#003366]/10 bg-white shadow-lg shadow-[#003366]/8" />
          </div>
        </div>
      </div>
  ...
  AcademyDetail: () => (
    <Skeleton loading={true} animate="shimmer" name="academydetail">
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans">
        <div className="aspect-video w-full bg-slate-100 border-b border-[#003366]/10" />
        <div className="px-6 mt-8 space-y-8">
          ...
          <div className="p-6 bg-white border border-[#003366]/10 shadow-lg shadow-[#003366]/8 rounded-[32px] space-y-4">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map(i => (
              <div key={i} className="flex items-center gap-4 p-5 bg-white border border-[#003366]/10 rounded-[24px] shadow-md shadow-[#003366]/8">
  ...
  Profile: () => (
    <Skeleton loading={true} animate="shimmer" name="profile">
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans pt-6">
        <div className="px-5 space-y-8">
          <div className="border border-[#003366]/10 bg-white rounded-[32px] p-7 shadow-lg shadow-[#003366]/8 space-y-8 relative overflow-hidden">
            ...
            <div className="space-y-3 relative z-10">
              {[1, 2, 3].map(i => (
                <div key={i} className="flex justify-between p-4 border border-[#003366]/8 items-center rounded-2xl bg-slate-50/50">
                  <div className="h-4 w-32 rounded-md bg-slate-100" />
            ...
            <div className="flex gap-4">
              <div className="h-16 flex-1 border border-[#003366]/10 rounded-2xl shadow-md shadow-[#003366]/8 bg-[#FF8C00]/10" />
              <div className="h-16 flex-1 border border-[#003366]/10 rounded-2xl shadow-md shadow-[#003366]/8 bg-[#00695C]/10" />
            </div>
          </div>

          <div className="flex gap-3 overflow-hidden">
            {[1, 2, 3].map(i => (
              <div key={i} className="h-12 w-28 border border-[#003366]/10 shadow-sm rounded-full flex-shrink-0 bg-white" />
            ))}
          </div>

          <div className="grid grid-cols-2 gap-5">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="aspect-[9/14] border border-[#003366]/10 shadow-md shadow-[#003366]/8 rounded-[24px] bg-white" />
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-md mx-auto min-h-screen bg-transparent font-sans pt-6">
        <div className="px-5 space-y-10">
          <div className="space-y-5">
            ...
            <div className="bg-white border border-[#003366]/10 p-5 rounded-[24px] flex items-center justify-between shadow-lg shadow-[#003366]/8">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 border border-[#003366]/10 rounded-xl bg-slate-100" />
                <div className="space-y-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-[#003366]/10 rounded-[32px] divide-y divide-[#003366]/8 shadow-lg shadow-[#003366]/8 overflow-hidden">
              {[1, 2, 3].map(i => (
                <div key={i} className="p-5 flex justify-between items-center">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl border border-[#003366]/10 bg-slate-100" />
                    <div className="space-y-2">
                      <div className="h-4 w-32 rounded-md bg-slate-100" />
                      <div className="h-3 w-16 rounded-md bg-slate-100 opacity-50" />
                    </div>
                  </div>
                  <div className="h-10 w-24 rounded-full border border-[#003366]/10 bg-slate-50" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="px-4 relative z-20 space-y-6">
          <section className="px-2 pt-2">
            <div className="flex items-center justify-center gap-6 px-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="flex flex-col items-center justify-center gap-2">
                  <div className="w-14 h-14 rounded-2xl border border-[#003366]/10 bg-white shadow-md shadow-[#003366]/8" />
          ...
          <section className="space-y-8 pb-12 mt-4">
            {[1, 2, 3].map(postIndex => (
              <div key={postIndex} className="bg-white border border-[#003366]/10 rounded-[32px] p-5 shadow-lg shadow-[#003366]/8 space-y-4">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-1.5 h-4 rounded-full bg-[#003366]/20 shrink-0" />
                  <div className="h-3 w-28 rounded-md bg-slate-100 opacity-40" />
                </div>
                <div className="flex gap-4 overflow-hidden">
                  {[1, 2, 3].map(cardIndex => (
                    <div key={cardIndex} className="flex-shrink-0 w-32 h-40 bg-slate-100 border border-[#003366]/10 rounded-2xl" />
                  ))}
                </div>
              </div>
            ))}
