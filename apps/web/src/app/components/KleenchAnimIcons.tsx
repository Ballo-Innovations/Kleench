  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="bell-shake" style={{ transformOrigin: "20px 12px" }}>
        <path d="M20 4C14.48 4 10 8.48 10 14v8l-2 3h24l-2-3v-8c0-5.52-4.48-10-10-10z" fill="#FF8C00" opacity="0.15"/>
        <path d="M20 4C14.48 4 10 8.48 10 14v8l-2 3h24l-2-3v-8c0-5.52-4.48-10-10-10z" stroke="#FF8C00" strokeWidth="1.8" strokeLinejoin="round"/>
        <path d="M17 28c0 1.66 1.34 3 3 3s3-1.34 3-3" stroke="#FF8C00" strokeWidth="1.8" strokeLinecap="round"/>
        <line x1="20" y1="4" x2="20" y2="2" stroke="#FF8C00" strokeWidth="2" strokeLinecap="round"/>
      </g>
      <circle className="dot-pulse" cx="30" cy="8" r="4" fill="#FF8C00"/>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="lock-bob" style={{ transformOrigin: "20px 20px" }}>
        <rect x="8" y="18" width="24" height="18" rx="4" fill="#0D1B3E" opacity="0.08" stroke="#0D1B3E" strokeWidth="1.8"/>
        <path d="M13 18v-5a7 7 0 0114 0v5" stroke="#0D1B3E" strokeWidth="1.8" strokeLinecap="round"/>
        <circle cx="20" cy="27" r="2.5" fill="#FF8C00"/>
        <line x1="20" y1="29.5" x2="20" y2="32" stroke="#FF8C00" strokeWidth="2" strokeLinecap="round"/>
      </g>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="coin-spin" style={{ transformOrigin: "20px 20px" }}>
        <circle cx="20" cy="20" r="14" fill="#FF8C00" opacity="0.15"/>
        <circle cx="20" cy="20" r="14" stroke="#FF8C00" strokeWidth="2"/>
        <text x="20" y="25" textAnchor="middle" fontSize="13" fontWeight="800" fill="#FF8C00" fontFamily="serif">K</text>
      </g>
    </Svg>
  );
}
...
export function TrophyIcon({ size = 40 }: IconProps) {
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <path d="M12 6h16v12a8 8 0 01-16 0V6z" fill="#FF8C00" opacity="0.15" stroke="#FF8C00" strokeWidth="1.8"/>
      <path d="M7 8H12v7a4 4 0 01-4-4V9a1 1 0 011-1z" fill="none" stroke="#FF8C00" strokeWidth="1.8" strokeLinejoin="round"/>
      <path d="M33 8H28v7a4 4 0 004-4V9a1 1 0 00-1-1z" fill="none" stroke="#FF8C00" strokeWidth="1.8" strokeLinejoin="round"/>
      <line x1="20" y1="26" x2="20" y2="30" stroke="#FF8C00" strokeWidth="2" strokeLinecap="round"/>
      <rect x="13" y="30" width="14" height="3" rx="1.5" fill="#FF8C00" opacity="0.4" stroke="#FF8C00" strokeWidth="1.5"/>
      <circle className="trophy-glow" cx="20" cy="15" r="3" fill="#FF8C00" opacity="0.5"/>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="cart-bounce" style={{ transformOrigin: "20px 20px" }}>
        <path d="M6 7h4l3.6 14.4A2 2 0 0015.5 23h13a2 2 0 001.96-1.6L33 12H11" stroke="#FF8C00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
        <circle cx="16" cy="29" r="2.5" fill="#FF8C00"/>
        <circle cx="27" cy="29" r="2.5" fill="#FF8C00"/>
      </g>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="rocket-fly" style={{ transformOrigin: "20px 20px" }}>
        <path d="M20 6C24 10 26 18 24 24l-4 4-4-4C14 18 16 10 20 6z" fill="#FF8C00" opacity="0.2" stroke="#FF8C00" strokeWidth="1.8" strokeLinejoin="round"/>
        <circle cx="20" cy="17" r="3" fill="#FF8C00"/>
        <path d="M16 24l-4 4 2 2 4-2M24 24l4 4-2 2-4-2" fill="#0D1B3E" opacity="0.3"/>
        <g className="flame" style={{ transformOrigin: "20px 28px" }}>
          <path d="M17 28l3 6 3-6" fill="#FF8C00" opacity="0.7"/>
        </g>
      </g>
    </Svg>
  );
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="user-wave">
        <circle cx="29" cy="14" r="5" fill="#FF8C00" opacity="0.15" stroke="#FF8C00" strokeWidth="1.8"/>
        <path d="M23 32c1-4 3.5-7 6-8" stroke="#FF8C00" strokeWidth="1.8" strokeLinecap="round" fill="none"/>
      </g>
    </Svg>
  );
}
...
export function ShareIcon({ size = 40 }: IconProps) {
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <circle cx="10" cy="20" r="4" stroke="#FF8C00" strokeWidth="1.8" fill="#FF8C00" fillOpacity="0.15"/>
      <circle cx="30" cy="10" r="4" stroke="#FF8C00" strokeWidth="1.8" fill="#FF8C00" fillOpacity="0.15"/>
      <circle cx="30" cy="30" r="4" stroke="#FF8C00" strokeWidth="1.8" fill="#FF8C00" fillOpacity="0.15"/>
      <path className="share-line" d="M14 18l12-7M14 22l12 7" stroke="#FF8C00" strokeWidth="1.8" strokeLinecap="round"/>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="gift-float">
        <rect x="7" y="17" width="26" height="18" rx="2" fill="#FF8C00" opacity="0.12" stroke="#FF8C00" strokeWidth="1.8"/>
        <rect x="5" y="12" width="30" height="6" rx="2" fill="#FF8C00" opacity="0.2" stroke="#FF8C00" strokeWidth="1.8"/>
        <path d="M20 12V35M14 12c-2-2-2-6 0-6 3 0 6 6 6 6M26 12c2-2 2-6 0-6-3 0-6 6-6 6" stroke="#FF8C00" strokeWidth="1.8" strokeLinecap="round"/>
      </g>
    </Svg>
  );
}
...
export function ChartIcon({ size = 40 }: IconProps) {
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <rect className="bar1" x="7"  y="22" width="7" height="12" rx="2" fill="#FF8C00" opacity="0.7" style={{ transformOrigin: "10.5px 34px" }}/>
      <rect className="bar2" x="17" y="14" width="7" height="20" rx="2" fill="#FF8C00"           style={{ transformOrigin: "20.5px 34px" }}/>
      <rect className="bar3" x="27" y="18" width="7" height="16" rx="2" fill="#00695C" opacity="0.8" style={{ transformOrigin: "30.5px 34px" }}/>
      <line x1="5" y1="35" x2="35" y2="35" stroke="#0D1B3E" strokeWidth="1.5" opacity="0.2" strokeLinecap="round"/>
    </Svg>
  );
}
...
export function EmptyIcon({ size = 80 }: IconProps) {
  return (
    <Svg size={size} viewBox="0 0 80 80">
      ...
      <ellipse className="empty-fade" cx="40" cy="62" rx="22" ry="6" fill="#0D1B3E" opacity="0.07"/>
      <g className="empty-float">
        <rect x="16" y="22" width="48" height="36" rx="6" fill="#F8F9FB" stroke="#0D1B3E" strokeWidth="1.5" strokeOpacity="0.15"/>
        <line x1="26" y1="34" x2="54" y2="34" stroke="#0D1B3E" strokeWidth="1.5" opacity="0.12" strokeLinecap="round"/>
        <line x1="26" y1="42" x2="48" y2="42" stroke="#0D1B3E" strokeWidth="1.5" opacity="0.08" strokeLinecap="round"/>
        <circle cx="40" cy="20" r="8" fill="#FF8C00" opacity="0.2" stroke="#FF8C00" strokeWidth="1.5"/>
        <path d="M37 19h6M40 16v6" stroke="#FF8C00" strokeWidth="2" strokeLinecap="round"/>
      </g>
    </Svg>
  );
}
  ...
  return (
    <Svg size={size} viewBox="0 0 40 40">
      ...
      <g className="sun-ray" style={{ transformOrigin: "20px 14px" }}>
        <circle cx="20" cy="14" r="5" fill="#FF8C00" opacity="0.3"/>
      ...
      <rect x="7" y="23" width="26" height="14" rx="2" fill="none" stroke="#FF8C00" strokeWidth="1.5" opacity="0.7"/>
      <line x1="7" y1="28" x2="33" y2="28" stroke="#FF8C00" strokeWidth="1" opacity="0.5"/>
      <line x1="7" y1="32" x2="33" y2="32" stroke="#FF8C00" strokeWidth="1" opacity="0.5"/>
      <line x1="16" y1="23" x2="16" y2="37" stroke="#FF8C00" strokeWidth="1" opacity="0.5"/>
      <line x1="24" y1="23" x2="24" y2="37" stroke="#FF8C00" strokeWidth="1" opacity="0.5"/>
    </Svg>
  );
}
